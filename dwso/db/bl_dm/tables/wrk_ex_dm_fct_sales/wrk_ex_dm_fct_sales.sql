DROP PARTITION FUNCTION pf_wrkDateFct;

CREATE PARTITION FUNCTION pf_wrkDateFct (date)  
AS RANGE LEFT FOR VALUES ('20200101', '20200201', '20200301', '20200401', '20200501', '20200601', '20200701', '20200801',  '20200901', '20201001', '20201101', '20201201',
						   ...
						   '20230101');
DROP PARTITION SCHEME ps_wrkDateFct;			   

CREATE PARTITION SCHEME ps_wrkDateFct
AS PARTITION pf_wrkDateFct ALL TO ([PRIMARY]);		
